...
$(".elt-work").click(function(){
  ...
  if(projectName == "Klein Blue" ){
    setTimeout(function(){
      location.href = "https://pm-kirill.github.io/PM-SITE/Site/work/klein.html";
    }, 1000);
  } else if(projectName == "Henri Mouraire") {
    setTimeout(function(){
      location.href = "https://pm-kirill.github.io/PM-SITE/Site/work/henrimouraire.html";
    }, 1000);
  } else if(projectName == "Words Cascade") {
    setTimeout(function(){
      location.href = "https://pm-kirill.github.io/PM-SITE/Site/work/cascade.html";
    }, 1000);
  } else if(projectName == "Otis monologue") {
    setTimeout(function(){
      location.href = "https://pm-kirill.github.io/PM-SITE/Site/work/otis.html";
    }, 1000);
  } else if (projectName == "Word Reveal") {
    setTimeout(function(){
      location.href = "https://pm-kirill.github.io/PM-SITE/Site/work/reveal.html";
    }, 1000);
  } else if (projectName == "Nike 3D shop") {
    setTimeout(function(){
      location.href = "https://pm-kirill.github.io/PM-SITE/Site/work/nike3d.html";
    }, 1000);
  } else if (projectName == "Fanette Bullat") {
    setTimeout(function(){
      location.href = "https://pm-kirill.github.io/PM-SITE/Site/work/fanettebullat.html";
    }, 1000);
  }
